...
// waitlist route
export const ADD_WAITLIST_USER_ERROR = {
  message: "Error adding user to waitlist",
  errorCode: "WAITLIST_101",
  statusCode: 500,
};
export const ADD_WAITLIST_USER_IN_DB_ERROR = {
  message: "Error adding user to waitlist in database",
  errorCode: "WAITLIST_102",
  statusCode: 500,
};
